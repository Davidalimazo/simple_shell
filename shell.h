...
/* this is for read and write buffers */
...
/**
 * struct liststr -defines singly linked list
 * @num: this represent number field
 ...
 *@env_changed: this will be on if environ was changed
 *@status: this return status of the last exec'd command
 *@cmd_buf: represent the address of pointer to cmd_buf, on if chaining
 ...
 *@type: represent builtin command flag
...
/* Holds toem_builtin.c */
int _myexit(info_t *);
int _mycd(info_t *);
int _myhelp(info_t *);

/* Holds toem_builtin1.c */
int _myhistory(info_t *);
int _myalias(info_t *);

/*Holds toem_getline.c */
ssize_t get_input(info_t *);
int _getline(info_t *, char **, size_t *);
void sigintHandler(int);

/* Holds toem_getinfo.c */
void clear_info(info_t *);
void set_info(info_t *, char **);
void free_info(info_t *, int);

/* Holds toem_environ.c */
